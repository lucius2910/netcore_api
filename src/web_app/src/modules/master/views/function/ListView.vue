        ...
        <vc-table :datas="functions" :tableConfig="tableConfig" :colConfigs="colConfig" :page="pageConfig"
          ...
          <template #action="{ data }">
            <div class="d-flex flex-center">
              <vc-button class="btn-action" type="primary" size="small" :icon="Edit" @click="onEdit(data)">
              </vc-button>

              <vc-button class="btn-action" type="danger" size="small" :icon="Delete" @click="onDeleteItem(data)">
              </vc-button>
            </div>
          </template>
        </vc-table>
