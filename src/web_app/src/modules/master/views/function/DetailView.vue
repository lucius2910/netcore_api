<template>
  <div class="vc-page">
    <vc-card class="mb-4 mt-2 pa-4">
      <vc-card-content>
        <el-form ref="roleForm" :model="func" :rules="rules" label-width="120px">
          <vc-row :gutter="20">
            <vc-col :lg="12" :md="12" :sm="24" :xs="24">
              <vc-input-group required :label="tl('Function', 'Module')">
                <vc-select v-model="func.module" :items="modules" fieldValue="key" fieldText="value"
                  :rules="[(v: any) => validate.required(v, tl('Function', 'Module'))]"></vc-select>
              </vc-input-group>

              <vc-input-group required :label="tl('Function', 'Code')">
                <vc-input v-model="func.code" :rules="[(v: any) => validate.required(v, tl('Function', 'Code'))]" />
              </vc-input-group>

              <vc-input-group required :label="tl('Function', 'Name')">
                <vc-input v-model="func.text" :rules="[(v: any) => validate.required(v, tl('Function', 'Name'))]" />
              </vc-input-group>
            ...
            <vc-col :lg="12" :md="12" :sm="24" :xs="24">
              <vc-input-group :label="tl('Function', 'Parent')">
                <vc-select v-model="func.parent" :items="parents" fieldValue="id" fieldText="fullName"></vc-select>
              </vc-input-group>
              ...
              <vc-input-group :label="tl('Function', 'Method')">
                <vc-select v-model="func.method" :items="methodItem" fieldValue="key" fieldText="value"></vc-select>
              </vc-input-group>
