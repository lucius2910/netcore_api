        ...
        <el-form ref="userForm" :model="user" :rules="rules" label-width="120px">
          <vc-row :gutter="20">
            <vc-col :lg="12" :md="12" :sm="24" :xs="24">
              ...
              <vc-input-group required prop="birthday" :label="tl('User', 'BidthDay')">
            ...
            <vc-col :lg="8" :md="12" :sm="24" :xs="24">
              <vc-input-group :label="tl('User', 'Role')">
                <vc-treeview ref="treeRef" :data="roles" v-model="user.roles" show-checkbox
                  style="width: 100%"></vc-treeview>
              </vc-input-group>
            </vc-col>
          </vc-row>
        </el-form>
