...
{
    public class ItemEdiCreateRequest
    {
    ...
    public class ItemEdiCreateRequestValidator : AbstractValidator<ItemEdiCreateRequest>
    {
        public ItemEdiCreateRequestValidator(IUnitOfWork _unitOfWork, ILocalizeServices _ls)
        {
            ...
            RuleFor(_ => _.edi_cd).NotNullOrEmpty().MaximumLength(15);
