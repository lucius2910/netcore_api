...
namespace Domain.Entities
{
    public class Company : BaseEntity
    {
        ...
        public virtual ICollection<ReceiveOrder> receive_order_cutomers { get; set; }

        public virtual ICollection<ReceiveOrder> receive_order_destinations { get; set; }
        ...
        public virtual ICollection<Shipment>? company_shipments { get; set; }
