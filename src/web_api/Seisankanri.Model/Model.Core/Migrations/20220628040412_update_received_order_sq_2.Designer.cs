...
namespace Model.Core.Migrations
{
    ...
    [Migration("20220628040412_update_received_order_sq_2")]
    partial class update_received_order_sq_2
    {
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.Company", b =>
                {
                    ...
                    b.Property<int>("bank_commission_burden_f")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("cover_handling_fee_div")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("detail_reconcile_f")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("plan_cc_display_f")
                        .HasColumnType("integer");

                    b.Property<int>("plan_cc_div")
                        .HasColumnType("integer");

                    b.Property<int>("plan_cc_months")
                        .HasColumnType("integer");

                    b.Property<int>("plan_prod_del_f")
                        .HasColumnType("integer");

                    b.Property<int>("plan_py_days")
                        .HasColumnType("integer");

                    b.Property<int>("plan_py_div")
                        .HasColumnType("integer");

                    b.Property<int>("plan_py_months")
                        .HasColumnType("integer");

                    b.Property<int>("po_if_div")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ReceiveOrder", b =>
                {
                    ...
                    b.Property<string>("code")
                        ...
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasDefaultValueSql("replace(concat(TO_CHAR(now(),'yyyyMMdd'), TO_CHAR(nextval('sq_receive_order'),'000000000')), ' ', '') ");
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.SalePlan", b =>
                {
                    ...
                    b.Property<string>("item_edi_code")
                        .IsRequired()
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)");
