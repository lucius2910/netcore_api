...
namespace Model.Core.Migrations
{
    ...
    [Migration("20220628035829_update_received_order_sq_1")]
    partial class update_received_order_sq_1
    {
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ReceiveOrder", b =>
                {
                    ...
                    b.Property<string>("code")
                        ...
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)")
                        .HasDefaultValueSql("concat_ws(TO_CHAR(now(), 'yyyyMMdd'),TO_CHAR(nextval('sq_receive_order'),'000000000')) ");
