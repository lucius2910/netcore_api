...
namespace Model.Core.Migrations
{
    ...
    [Migration("20220729024926_update_unique_item_edi")]
    partial class update_unique_item_edi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.InventoryTotal", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("curmth_whin_qty1")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty10")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty2")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty3")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty4")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty5")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty6")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty7")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty8")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whin_qty9")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty1")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty10")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty2")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty3")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty4")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty5")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty6")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty7")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty8")
                        .HasColumnType("integer");

                    b.Property<int?>("curmth_whout_qty9")
                        .HasColumnType("integer");

                    b.Property<bool>("del_flg")
                        .HasColumnType("boolean");

                    b.Property<bool>("inspection_k")
                        .HasMaxLength(2)
                        .HasColumnType("boolean");

                    b.Property<string>("inventory_cd")
                        .IsRequired()
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)");

                    b.Property<string>("inventory_k")
                        .IsRequired()
                        .HasMaxLength(2)
                    ...
                    b.Property<string>("item_div")
                        .IsRequired()
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");

                    b.Property<string>("last_invt_date")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("last_whin_date")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<string>("last_whout_date")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.Property<string>("lot_cd")
                        .HasMaxLength(15)
                        .HasColumnType("character varying(15)");

                    b.Property<int?>("nextmth_whin_qty")
                        .HasColumnType("integer");

                    b.Property<int?>("nextmth_whout_qty")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("silo_k")
                        .HasMaxLength(2)
                        .HasColumnType("character varying(2)");

                    b.Property<int?>("stock_amt")
                        .HasColumnType("integer");

                    b.Property<string>("stock_cutoff_date")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
                    ...
                    b.Property<DateTime?>("whin_dt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("whin_qty_plan_po")
                        .HasColumnType("integer");

                    b.Property<int?>("whin_qty_plan_pp")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("inventory_total", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ItemBuyPrices", b =>
                {
                    ...
                    b.ToTable("item_buy_prices", "public");
                });

            modelBuilder.Entity("Seisankanri.Model.Entities.ItemEdi", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("company_cd", "item_cd", "edi_cd")
                        .IsUnique();

                    b.ToTable("item_edi", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ItemSalePrices", b =>
                {
                    ...
                    b.ToTable("item_sale_prices", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ProductPlanDay", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("estimate_inventory")
                        .HasColumnType("integer");

                    b.Property<int?>("estimate_shipment_results")
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("plan_day")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("production_results")
                        .HasColumnType("integer");

                    b.Property<int?>("production_schedule")
                        .HasColumnType("integer");

                    b.Property<int?>("shipment_results")
                        .HasColumnType("integer");

                    b.Property<int?>("to_be_sold")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("product_plan_day", "public");
                });

            modelBuilder.Entity("Seisankanri.Model.Entities.ProductPlanMonth", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("machine_names")
                        .HasMaxLength(250)
                        .HasColumnType("character varying(250)");

                    b.Property<DateTime>("plan_month")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("pre_month_inventory")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("product_plan_month", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ReceiveOrder", b =>
                {
                    ...
                    b.ToTable("receive_order", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.ReceiveOrderDt", b =>
                {
                    ...
                    b.ToTable("receive_order_dt", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.SalePlan", b =>
                {
                    ...
                    b.HasIndex("item_edi_cd");

                    b.ToTable("sale_plan", "public");
                });
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.SystemSettings", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.SalePlan", b =>
                {
                    ...
                    b.HasOne("Seisankanri.Model.Entities.Item", "item")
                        .WithMany("item_sale_plans")
                        .HasForeignKey("item_cd")
                        .HasPrincipalKey("code")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Seisankanri.Model.Entities.ItemEdi", "item_edi")
                        .WithMany("sale_plans")
                        .HasForeignKey("item_edi_cd")
                        .HasPrincipalKey("edi_cd")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.Company", b =>
                {
                    ...
                    b.Navigation("item_edi_companys");
                    ...
                    b.Navigation("sale_plan_companys");
            ...
            modelBuilder.Entity("Seisankanri.Model.Entities.Item", b =>
                {
                    b.Navigation("inventory_totals");

                    b.Navigation("item_buy_prices");

                    b.Navigation("item_edis");

                    b.Navigation("item_prices");

                    b.Navigation("item_sale_plans");

                    b.Navigation("item_sale_prices");

                    b.Navigation("product_plan_days");

                    b.Navigation("product_plan_months");
