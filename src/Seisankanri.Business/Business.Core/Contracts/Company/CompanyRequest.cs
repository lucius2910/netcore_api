...
namespace Business.Core.Contracts
{
    ...
    public class CompanyRequestValidator : AbstractValidator<CompanyRequest>
    {
        public CompanyRequestValidator()
        {
            ...
            RuleFor(_ => _.group_cd).MaximumLength(15);
            RuleFor(_ => _.short_name_kana).MaximumLength(32);
            RuleFor(_ => _.area_cd).MaximumLength(15);
            RuleFor(_ => _.business_category_cd).MaximumLength(15);
            RuleFor(_ => _.place_div).MaximumLength(15);
            RuleFor(_ => _.emp_cd).NotNullOrEmpty().MaximumLength(15);
            RuleFor(_ => _.ex_edi_company_cd).MaximumLength(15);
            ...
            RuleFor(_ => _.postal_cd).NotNullOrEmpty().MaximumLength(15);
            RuleFor(_ => _.address1).NotNullOrEmpty().MaximumLength(160);
            RuleFor(_ => _.address2).MaximumLength(160);
            RuleFor(_ => _.tel_no).NotNullOrEmpty().MaximumLength(30);
            RuleFor(_ => _.extension_no).MaximumLength(5);
            ...
            RuleFor(_ => _.remarks1).MaximumLength(240);
            RuleFor(_ => _.remarks2).MaximumLength(240);
            RuleFor(_ => _.sa_emp_cd).NotNullOrEmpty().MaximumLength(15);
            RuleFor(_ => _.cc_div).MaximumLength(8);
            RuleFor(_ => _.cc_bank_cd).MaximumLength(15);
            RuleFor(_ => _.billing_cd).MaximumLength(15);
            ...
            RuleFor(_ => _.carrier_div).MaximumLength(15);
            RuleFor(_ => _.pu_emp_cd).MaximumLength(15);
            RuleFor(_ => _.py_div).MaximumLength(15);
            RuleFor(_ => _.payee_bank_cd).MaximumLength(15);
            RuleFor(_ => _.peyee_bank_account_div).MaximumLength(15);
            RuleFor(_ => _.peyee_bank_account_cd).MaximumLength(20);
            RuleFor(_ => _.payer_bank_cd).MaximumLength(15);
            RuleFor(_ => _.payee_cd).MaximumLength(15);
            RuleFor(_ => _.pu_rd_div).MaximumLength(15);
            RuleFor(_ => _.pu_tax_calc_div).MaximumLength(15);
            RuleFor(_ => _.pu_tax_rd_div).MaximumLength(15);
            RuleFor(_ => _.emp_mail_address).NotNullOrEmpty().MaximumLength(240);
            RuleFor(_ => _.emp_phone).NotNullOrEmpty().MaximumLength(240);
            RuleFor(_ => _.carrier_div2).MaximumLength(15);
            RuleFor(_ => _.bank_commission_burden_f).MaximumLength(1);
            RuleFor(_ => _.commission_div).MaximumLength(15);
            RuleFor(_ => _.transf_div).MaximumLength(15);
            RuleFor(_ => _.post_div).MaximumLength(15);
            RuleFor(_ => _.detail_reconcile_f).MaximumLength(15);
            RuleFor(_ => _.plan_cc_display_f).MaximumLength(15);
            RuleFor(_ => _.plan_cc_div).MaximumLength(15);
            RuleFor(_ => _.edi_conv_cd).MaximumLength(40);
            RuleFor(_ => _.plan_prod_del_f).MaximumLength(1);
            RuleFor(_ => _.po_if_div).MaximumLength(1);
            RuleFor(_ => _.pu_tax_div).MaximumLength(15);
            RuleFor(_ => _.plan_py_div).MaximumLength(1);
            RuleFor(_ => _.py_transf_div).MaximumLength(15);
            RuleFor(_ => _.py_post_div).MaximumLength(15);
            RuleFor(_ => _.cover_handling_fee_div).MaximumLength(1);
            RuleFor(_ => _.commission_paid_div).MaximumLength(15);
            RuleFor(_ => _.ar_currency_cd).MaximumLength(3);
            RuleFor(_ => _.ar_for_cur_amt_rd_div).MaximumLength(15);
            RuleFor(_ => _.ar_unitprice_conv_rd_div).MaximumLength(15);
            RuleFor(_ => _.ar_amt_conv_rd_div).MaximumLength(15);
            RuleFor(_ => _.ap_currency_cd).MaximumLength(3);
            RuleFor(_ => _.ap_for_cur_amt_rd_div).MaximumLength(15);
            RuleFor(_ => _.ap_unitprice_conv_rd_div).MaximumLength(15);
            RuleFor(_ => _.ap_amt_conv_rd_div).MaximumLength(15);
            RuleFor(_ => _.bank_cd).NotNullOrEmpty().MaximumLength(15);
            RuleFor(_ => _.bank_account_number).NotNullOrEmpty().MaximumLength(15);
            RuleFor(_ => _.bank_account_name).NotNullOrEmpty().MaximumLength(40);
        }
    }
}
